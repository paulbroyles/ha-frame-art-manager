  ...
  unifiedProcessors: [
    { value: 'scored_crop', label: 'Scored Crop — score candidate crop rectangles for edge uniformity and interior complexity; finds painting without explicit frame detection',
      ...
      options: [
        ...
        { key: 'centeringWeight', label: 'Centering Weight', type: 'number', default: 0.15,
          description: 'Penalty for candidates whose center is far from the image center (0–1). Prevents asymmetric frame material from pushing the crop off-center. Set to 0 to disable.' },
      ] },
